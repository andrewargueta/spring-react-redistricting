...
class Map extends Component {
  ...
  handleCallback = (data) =>{
    ...
    if(data[2].props.state === "Texas"){
      old_x =Array.from({length: 36}, (_, i) => i + 1);
      if(data[2].props.minorityGroups === "black "){
        old_y=[0.185950780347677,0.125639326098355,0.100014937356461,0.107387127943768,0.164814000711759,0.205037865369702,0.142744115513945,0.0919321252935182,
          ...
          0.128621994615254,0.449788892497564,0.0609077685170624,0.0553717037814124,0.0354808354757944,0.146431974783756,0.0381136133603239,0.123233932695314,
          0.0738577808313294,0.0822716590391038,0.0530589142293917,0.0550332355230852,0.160739016833479,0.520792270117405,0.112507058159232,0.129814854224303,
          0.243450209532998,0.016070360177097,0.103364937720766,0.0969058578228884];
      }
      if(data[2].props.minorityGroups === "hisp "){
        old_y=[0.08948578987,0.2175934628,0.09917471106,0.07502699835,0.1484854194,0.1599345135,0.2003582339,0.1383633866,0.2476253252,0.1903433692,0.3028359631,0.1587112822,0.1862328802,0.1752690449,0.7376702256,0.7598548006,0.1811420933,0.2681065281,0.3009907218,0.6501740499,0.2470047554,0.2073651224,0.6286373988,0.1540424159,0.142924298,0.127798491,0.4634286774,0.6906162046,0.6418709576,0.2279544091,0.1953698475,0.1526667275,0.4705297115,0.7843604164,0.523419536,0.1709547976];
      }

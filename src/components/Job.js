                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <button type="button" class="btn btn-danger" onClick={this.cancelJob}  data-dismiss="modal" >Cancel Job</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="modal fade" id={"modal"+this.props.jobNum} data-backdrop="false" tabIndex="-1" role="dialog"  aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                      <button type="button" class="btn btn-danger"   data-dismiss="modal" onClick={this.deleteJob}>Delete Job</button>
                                    </div>
                                  </div>
                                </div>
                              </div>

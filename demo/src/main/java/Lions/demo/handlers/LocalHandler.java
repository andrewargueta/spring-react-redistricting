...
public class LocalHandler {
    ...
    public void runLocalJob(int jobId, InputParam config, State selectedState, String JSONObject){
        try {
            ...
            ProcessBuilder pb = new ProcessBuilder("C:/Users/Billy/AppData/Local/Programs/Python/Python39/python.exe", "demo/src/main/resources/algorithm.py", String.valueOf(jobId), String.valueOf(config.getNumOfPlans()), String.valueOf(config.getPopulationVariation()), config.getState());
